...
#passlib.hah is used for encrypting our password we want to use. 
...
def add_student():
    ...
    if request.method == 'POST' and form.validate():
        ...
        cur.execute("INSERT INTO `student`(`name`,`gender`,`puc`,`pucboard`, `high`, `highboard`, `sub`, `degree`, `workex`, `testscore`, `spec`,`Caste`,`prevmark`,`income`)VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(name,gender,puc,pucboard,high,highboard,sub,degree,workex,testscore,spec,Caste,prevmark,income))
